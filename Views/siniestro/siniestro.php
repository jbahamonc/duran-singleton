										...
										<div class="col-md-10 col-md-offset-1">
											<div class="form-group">
												<div class="input-group">
													...
													<input type="text" class="form-control" placeholder="Placa del Vehiculo *">
												</div>
											</div>
											<div class="form-group">
												<div class="input-group">
										...
										<ul class="media-list">
											<li class="table-caract display-inline-block">
												...
												<div class="media-right media-middle">
													<button type="button" class="btn btn-rounded bg-danger dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
															...
															<div class="editableform">
																<div class="control-group form-group no-margin">
																	...
																	<div class="editable-buttons editable-buttons-bottom">
																		<button type="submit" class="btn btn-primary btn-icon editable-submit">
